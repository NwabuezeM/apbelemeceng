          ...
          <input type='email' id='email' value={email} onChange={onChange} className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' placeholder='Email Address' required/>
            ...
            <div className='flex justify-between text-sm sm:text-lg'>
              <p className='mb-6'>
                ...
                <Link to='/sign-up' className='text-[#0077be] hover:text-red-500 transition duration-200 ease-in-out ml-1'> Register</Link>
              </p>
              <p>
                <Link to="/sign-in" className='text-[#0077be] hover:text-red-500 transition duration-200 ease-in-out'>Sign in instead</Link>
              </p>
            </div>
            <button type="submit" className='bg-[#0077ee] text-white w-full py-3 mx-auto rounded-[8px] hover:bg-[#454b4e] font-medium uppercase shadow-md transition duration-300 ease-in-out'>Send reset link</button>
