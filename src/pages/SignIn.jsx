      ...
      <div className='flex justify-center flex-wrap items-center py-6 px-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            <button type="submit" className='bg-[#0077ee] text-white w-full py-3 mx-auto rounded-[8px] hover:bg-[#454b4e] font-medium uppercase shadow-md transition duration-300 ease-in-out'>Sign in</button>
